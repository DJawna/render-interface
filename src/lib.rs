mod core {
    ...
    pub trait Renderer{
        ...
        fn paint_rect2d(x: f32,y: f32,width: f32, height: f32,red: u8, green: u8, blue: u8, alpha: u8)-> Option<String>;


        // displays a texture at the target_x and target_y coordinates
        fn draw_texture2d(  texture_id   : u32, 
                            source_x     : u32,
                            source_y     : u32, 
                            source_width : u32, 
                            source_height: u32, 
        ...
        fn clear(red: u8, green: u8, blue: u8)-> Option<String>; 
    } 
}
